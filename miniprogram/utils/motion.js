...
const FALLBACK_GLYPH = {
  杠铃: 'barbell', 哑铃: 'dumbbell-pair', 绳索: 'cable', 自重: 'bodyweight',
  器械: 'machine-generic', 悍马: 'machine-generic', 插片机: 'machine-generic',
  弹力带: 'cable', 单杠: 'pullup-bar', 壶铃: 'dumbbell', 杠铃片: 'barbell',
  有氧器械: 'machine-generic', 瑞士球: 'bodyweight', 毛巾: 'bodyweight'
};
const FALLBACK_MOTION = {
  胸: 'bench-press', 背: 'row', 腿: 'squat', 肩: 'shoulder-press', 手臂: 'curl',
  核心: 'crunch', 臀腿: 'hip-thrust', 有氧: 'mountain-climber', 拉伸: 'plank'
};
...
const ANIM_FALLBACK_BY_PART = {
  胸: 'bench-press', 背: 'machine-row', 腿: 'squat', 肩: 'overhead-press', 手臂: 'bicep-curl',
  核心: 'crunch', 臀腿: 'hip-thrust', 有氧: 'mountain-climber', 拉伸: 'plank'
};
