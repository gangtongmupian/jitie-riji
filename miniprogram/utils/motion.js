...
const MOTION_BY_ID = {
  ...
  'smith-machine-bench-press': 'bench-press', 'incline-cable-fly': 'chest-fly',
  'decline-dumbbell-press': 'decline-press', 'weighted-push-up': 'pushup',
  'chest-supported-row': 'row', 'pendlay-row': 'row', 'single-arm-cable-row': 'row',
  'rack-pull': 'deadlift', 'inverted-row': 'row', 'straight-arm-pulldown': 'lat-pulldown',
  'dumbbell-shrug': 'shrug', 'machine-shoulder-press': 'shoulder-press',
  'machine-lateral-raise': 'lateral-raise', 'cable-lateral-raise': 'lateral-raise',
  'reverse-pec-deck': 'rear-delt', 'bulgarian-split-squat': 'lunge', 'reverse-lunge': 'lunge',
  'step-up': 'lunge', 'wall-sit': 'squat', 'seated-leg-curl': 'leg-curl',
  'good-morning': 'rdl', 'nordic-hamstring-curl': 'leg-curl', 'single-leg-rdl': 'rdl',
  'seated-calf-raise': 'calf-raise', 'leg-press-calf-raise': 'calf-raise',
  'trap-bar-deadlift': 'deadlift', 'cable-pull-through': 'hip-thrust',
  'dumbbell-hip-thrust': 'hip-thrust', 'donkey-kick': 'glute-kickback', 'clamshell': 'hip-abduction',
  'ab-wheel': 'crunch', 'pallof-press': 'russian-twist', 'cable-woodchop': 'russian-twist',
  'reverse-crunch': 'crunch', 'bird-dog': 'dead-bug', 'hanging-knee-raise': 'leg-raise',
  'close-grip-bench-press': 'bench-press', 'cable-curl': 'curl', 'concentration-curl': 'curl',
  'rope-tricep-pushdown': 'triceps-pushdown', 'dumbbell-skull-crusher': 'skull-crusher',
  'farmer-carry': 'shrug',
  // FORWARD 固定器械
  'fwd-fws-001': 'chest-fly', 'fwd-fws-002': 'lat-pulldown', 'fwd-fws-003': 'row',
  'fwd-fws-004': 'bench-press', 'fwd-fws-005': 'shoulder-press', 'fwd-fws-006': 'curl',
  'fwd-fws-008': 'pullover', 'fwd-fws-009': 'chest-fly', 'fwd-fws-011': 'crunch',
  'fwd-fws-012': 'leg-extension', 'fwd-fws-013': 'leg-curl', 'fwd-fws-014': 'leg-press',
  'fwd-fws-015': 'hip-abduction', 'fwd-fws-019': 'hip-thrust', 'fwd-fws-021': 'row',
  'fwd-fws-022': 'chest-fly', 'fwd-fws-030': 'row', 'fwd-fws-031': 'row',
  'fwd-fws-032': 'chest-fly', 'fwd-fws-033': 'row', 'fwd-fws-034': 'row', 'fwd-fws-035': 'row',
  'fwd-fwhm-001': 'bench-press', 'fwd-fwhm-002': 'shoulder-press', 'fwd-fwhm-003': 'hip-abduction',
  'fwd-fwhm-004': 'row', 'fwd-fwhm-005': 'lat-pulldown', 'fwd-fwhm-006': 'row',
  'fwd-fwhm-007': 'lat-pulldown', 'fwd-fwhm-008': 'curl', 'fwd-fwhm-009': 'lateral-raise',
  'fwd-fwhm-010': 'incline-press', 'fwd-fwhm-012': 'leg-curl', 'fwd-fwhm-013': 'leg-extension',
  'fwd-fwhm-014': 'chest-fly', 'fwd-fwhm-015': 'chest-fly', 'fwd-fwhm-016': 'hack-squat',
  'fwd-fwhm-017': 'hack-squat', 'fwd-fwhm-018': 'leg-press', 'fwd-fwhm-021': 'squat',
  'fwd-fwhm-023': 'hip-thrust', 'fwd-fwhm-024': 'hip-thrust', 'fwd-fwhm-025': 'dip',
  'fwd-fwhm-031': 'pullover', 'fwd-fwhm-032': 'hack-squat', 'fwd-fwhm-033': 'hack-squat',
  'fwd-fwhm-034': 'hip-abduction', 'fwd-fwhm-035': 'row',
  'fwd-rrs-001': 'chest-fly', 'fwd-rrs-002': 'lat-pulldown', 'fwd-rrs-003': 'row',
...
const GLYPH_BY_ID = {
  ...
  // 2026-08 扩充：workout-guide 高频动作
  'smith-machine-bench-press': 'machine-chest-press', 'incline-cable-fly': 'cable',
  'decline-dumbbell-press': 'dumbbell-pair', 'weighted-push-up': 'bodyweight',
  'chest-supported-row': 'machine-row', 'pendlay-row': 'barbell', 'single-arm-cable-row': 'cable',
  'rack-pull': 'barbell', 'inverted-row': 'bodyweight', 'straight-arm-pulldown': 'cable',
  'dumbbell-shrug': 'dumbbell-pair', 'machine-shoulder-press': 'machine-shoulder-press',
  'machine-lateral-raise': 'machine-lateral', 'cable-lateral-raise': 'cable',
  'reverse-pec-deck': 'machine-fly', 'bulgarian-split-squat': 'dumbbell-pair',
  'reverse-lunge': 'dumbbell-pair', 'step-up': 'dumbbell-pair', 'wall-sit': 'bodyweight',
  'seated-leg-curl': 'machine-leg-curl', 'good-morning': 'barbell',
  'nordic-hamstring-curl': 'bodyweight', 'single-leg-rdl': 'dumbbell',
  'seated-calf-raise': 'machine-calf', 'leg-press-calf-raise': 'machine-leg-press',
  'trap-bar-deadlift': 'barbell', 'cable-pull-through': 'cable',
  'dumbbell-hip-thrust': 'dumbbell-pair', 'donkey-kick': 'bodyweight', 'clamshell': 'bodyweight',
  'ab-wheel': 'bodyweight', 'pallof-press': 'cable', 'cable-woodchop': 'cable',
  'reverse-crunch': 'bodyweight', 'bird-dog': 'bodyweight', 'hanging-knee-raise': 'pullup-bar',
  'close-grip-bench-press': 'barbell', 'cable-curl': 'cable', 'concentration-curl': 'dumbbell',
  'rope-tricep-pushdown': 'cable', 'dumbbell-skull-crusher': 'dumbbell-pair',
  'farmer-carry': 'dumbbell-pair',
  // FORWARD 固定器械
  'fwd-fws-001': 'machine-fly', 'fwd-fws-002': 'machine-lat-pulldown', 'fwd-fws-003': 'machine-row',
  'fwd-fws-004': 'machine-chest-press', 'fwd-fws-005': 'machine-shoulder-press',
  'fwd-fws-006': 'machine-curl', 'fwd-fws-008': 'machine-pullover', 'fwd-fws-009': 'machine-fly',
  'fwd-fws-011': 'machine-crunch', 'fwd-fws-012': 'machine-leg-extension',
  'fwd-fws-013': 'machine-leg-curl', 'fwd-fws-014': 'machine-leg-press',
  'fwd-fws-015': 'machine-hip-abduction', 'fwd-fws-019': 'machine-hip-thrust',
  'fwd-fws-021': 'machine-row', 'fwd-fws-022': 'machine-fly', 'fwd-fws-030': 'machine-row',
  'fwd-fws-031': 'machine-row', 'fwd-fws-032': 'cable', 'fwd-fws-033': 'machine-row',
  'fwd-fws-034': 'machine-row', 'fwd-fws-035': 'machine-row',
  'fwd-fwhm-001': 'machine-chest-press', 'fwd-fwhm-002': 'machine-shoulder-press',
  'fwd-fwhm-003': 'machine-hip-abduction', 'fwd-fwhm-004': 'machine-row',
  'fwd-fwhm-005': 'machine-lat-pulldown', 'fwd-fwhm-006': 'machine-row',
  'fwd-fwhm-007': 'machine-lat-pulldown', 'fwd-fwhm-008': 'machine-curl',
  'fwd-fwhm-009': 'machine-lateral', 'fwd-fwhm-010': 'machine-chest-press',
  'fwd-fwhm-012': 'machine-leg-curl', 'fwd-fwhm-013': 'machine-leg-extension',
  'fwd-fwhm-014': 'machine-fly', 'fwd-fwhm-015': 'machine-fly', 'fwd-fwhm-016': 'machine-hack-squat',
  'fwd-fwhm-017': 'machine-hack-squat', 'fwd-fwhm-018': 'machine-leg-press',
  'fwd-fwhm-021': 'machine-hack-squat', 'fwd-fwhm-023': 'machine-hip-thrust',
  'fwd-fwhm-024': 'machine-hip-thrust', 'fwd-fwhm-025': 'dip-bars',
  'fwd-fwhm-031': 'machine-pullover', 'fwd-fwhm-032': 'machine-hack-squat',
  'fwd-fwhm-033': 'machine-hack-squat', 'fwd-fwhm-034': 'machine-hip-abduction',
  'fwd-fwhm-035': 'machine-row',
  'fwd-rrs-001': 'machine-fly', 'fwd-rrs-002': 'machine-lat-pulldown', 'fwd-rrs-003': 'machine-row',
  'fwd-rrs-004': 'machine-chest-press', 'fwd-rrs-005': 'machine-shoulder-press',
  'fwd-rrs-006': 'machine-curl', 'fwd-rrs-007': 'machine-chest-press',
...
const ANIM_BY_ID = {
  ...
  // 2026-08 扩充：workout-guide 高频动作
  'smith-machine-bench-press': 'bench-press', 'incline-cable-fly': 'cable-fly',
  'decline-dumbbell-press': 'decline-bench-press', 'weighted-push-up': 'push-up',
  'chest-supported-row': 'machine-row', 'pendlay-row': 'barbell-row',
  'single-arm-cable-row': 'one-arm-dumbbell-row', 'rack-pull': 'deadlift',
  'inverted-row': 'barbell-row', 'straight-arm-pulldown': 'straight-arm-pulldown',
  'dumbbell-shrug': 'shrug', 'machine-shoulder-press': 'machine-shoulder-press',
  'machine-lateral-raise': 'machine-lateral-raise', 'cable-lateral-raise': 'lateral-raise',
  'reverse-pec-deck': 'rear-delt-fly', 'bulgarian-split-squat': 'forward-lunge',
  'reverse-lunge': 'forward-lunge', 'step-up': 'forward-lunge', 'wall-sit': 'squat',
  'seated-leg-curl': 'lying-leg-curl', 'good-morning': 'romanian-deadlift',
  'nordic-hamstring-curl': 'lying-leg-curl', 'single-leg-rdl': 'romanian-deadlift',
  'seated-calf-raise': 'seated-calf-raise', 'leg-press-calf-raise': 'standing-calf-raise',
  'trap-bar-deadlift': 'deadlift', 'cable-pull-through': 'hip-thrust',
  'dumbbell-hip-thrust': 'hip-thrust', 'donkey-kick': 'cable-kickback',
  'clamshell': 'hip-abduction-machine', 'ab-wheel': 'crunch', 'pallof-press': 'russian-twist',
  'cable-woodchop': 'russian-twist', 'reverse-crunch': 'crunch', 'bird-dog': 'dead-bug',
  'hanging-knee-raise': 'hanging-leg-raise', 'close-grip-bench-press': 'bench-press',
  'cable-curl': 'bicep-curl', 'concentration-curl': 'bicep-curl',
  'rope-tricep-pushdown': 'tricep-pushdown', 'dumbbell-skull-crusher': 'skull-crusher',
  'farmer-carry': 'shrug',
  // FORWARD 固定器械
  'fwd-fws-001': 'pec-deck', 'fwd-fws-002': 'lat-pulldown', 'fwd-fws-003': 'machine-row',
  'fwd-fws-004': 'machine-chest-press', 'fwd-fws-005': 'machine-shoulder-press',
  'fwd-fws-006': 'bicep-curl', 'fwd-fws-008': 'straight-arm-pulldown', 'fwd-fws-009': 'pec-deck',
  'fwd-fws-011': 'crunch', 'fwd-fws-012': 'leg-extension', 'fwd-fws-013': 'lying-leg-curl',
  'fwd-fws-014': 'leg-press', 'fwd-fws-015': 'hip-abduction-machine', 'fwd-fws-019': 'hip-thrust',
  'fwd-fws-021': 'machine-row', 'fwd-fws-022': 'pec-deck', 'fwd-fws-030': 'machine-row',
  'fwd-fws-031': 'machine-row', 'fwd-fws-032': 'cable-fly', 'fwd-fws-033': 'machine-row',
  'fwd-fws-034': 'machine-row', 'fwd-fws-035': 'machine-row',
  'fwd-fwhm-001': 'machine-chest-press', 'fwd-fwhm-002': 'machine-shoulder-press',
  'fwd-fwhm-003': 'hip-abduction-machine', 'fwd-fwhm-004': 'machine-row',
  'fwd-fwhm-005': 'lat-pulldown', 'fwd-fwhm-006': 'machine-row', 'fwd-fwhm-007': 'lat-pulldown',
  'fwd-fwhm-008': 'bicep-curl', 'fwd-fwhm-009': 'machine-lateral-raise',
  'fwd-fwhm-010': 'incline-bench-press', 'fwd-fwhm-012': 'lying-leg-curl',
  'fwd-fwhm-013': 'leg-extension', 'fwd-fwhm-014': 'pec-deck', 'fwd-fwhm-015': 'pec-deck',
  'fwd-fwhm-016': 'hack-squat', 'fwd-fwhm-017': 'hack-squat', 'fwd-fwhm-018': 'leg-press',
  'fwd-fwhm-021': 'squat', 'fwd-fwhm-023': 'hip-thrust', 'fwd-fwhm-024': 'hip-thrust',
  'fwd-fwhm-025': 'chest-dip', 'fwd-fwhm-031': 'straight-arm-pulldown',
  'fwd-fwhm-032': 'hack-squat', 'fwd-fwhm-033': 'hack-squat',
  'fwd-fwhm-034': 'hip-abduction-machine', 'fwd-fwhm-035': 'machine-row',
  'fwd-rrs-001': 'pec-deck', 'fwd-rrs-002': 'lat-pulldown', 'fwd-rrs-003': 'machine-row',
  'fwd-rrs-004': 'machine-chest-press', 'fwd-rrs-005': 'machine-shoulder-press',
  'fwd-rrs-006': 'bicep-curl', 'fwd-rrs-007': 'incline-bench-press',
